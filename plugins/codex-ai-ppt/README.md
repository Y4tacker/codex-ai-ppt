...
This repository includes a local marketplace file at `.agents/plugins/marketplace.json`. From the repository root:
...
If the marketplace is already listed as `personal  /Users/hola/Desktop/aippt`, do not add it again. Install this plugin as `codex-ai-ppt@personal`.
...
| Marketplace name | `personal` in this repository |
